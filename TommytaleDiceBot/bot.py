...
d8s = ["img/d8-1.png", "img/d8-2.png", "img/d8-3.png", "img/d8-4.png", "img/d8-5.png", "img/d8-6.png", "img/d8-7.png",
       "img/d8-8.png"]

d10s = ["img/d10-1.png", "img/d10-2.png", "img/d10-3.png", "img/d10-4.png", "img/d10-5.png", "img/d10-6.png",
        "img/d10-7.png",
        "img/d10-8.png", "img/d10-9.png", "img/d10-0.png"]

d12s = ["img/d12-1.png", "img/d12-2.png", "img/d12-3.png", "img/d12-4.png", "img/d12-5.png", "img/d12-6.png",
        "img/d12-7.png",
        "img/d12-8.png", "img/d12-9.png", "img/d12-10.png", "img/d12-11.png", "img/d12-12.png"]

d20s = ["img/d20-1.png", "img/d20-2.png", "img/d20-3.png", "img/d20-4.png", "img/d20-5.png", "img/d20-6.png",
        "img/d20-7.png",
        "img/d20-8.png", "img/d20-9.png", "img/d20-10.png", "img/d20-11.png", "img/d20-12.png", "img/d20-13.png",
        "img/d20-14.png",
        "img/d20-15.png", "img/d20-16.png", "img/d20-17.png", "img/d20-18.png", "img/d20-19.png", "img/d20-20.png"]

d100s = ["img/d100-00.png", "img/d100-10.png", "img/d100-20.png", "img/d100-30.png", "img/d100-40.png",
         "img/d100-50.png",
...
def critic_fail():
    phrases = ["BWAHAHAHAAHAHAHAHAHAHAHAHAHAHAHAHAHAH", "finalmente", "* happy evil dice noises *",
               "* sad player noises *",
...
def fails():
    fails_phrases = ["Che schifo", "Sorry ;>", "mi dispiace", "forse la prossima",
...
def limit_numbers():
    limits_phrases = ["buona fortuna", "auguri", "scelta del DM", "confine",
...
def max_number():
    max_phrases = ["come?!?", "NANI", "DA FUCK", "WTF", "WHAT THE FUCK", "COSA?", "stai cheattando", "non ho parole",
                   "complimenti", "fantastico", "gli dei ti hanno aiutato",
                   "gli dei ti hanno conferito il potere di modellare le terre, aprire  le acque, spostare montagne o distruggiore un esercito",
                   "gli dei ti hanno conferito il potere di modellare le terre, aprire  le acque, spostare montagne o distruggiore un esercito, ma tu...",
       ...
       if message.content.startswith(client.user + " bot stupido"):
        ...
        if (not simplemode):
            ...
            if message.content.startswith('!d20'):
                await message.channel.send(str(message.author) + " il dado ha per te deciso:",
                                           file=discord.File(gen_d20()))
            elif message.content.startswith('!d4'):
                await message.channel.send(str(message.author) + " il dado ha per te deciso:",
                                           file=discord.File(gen_d4()))
            elif message.content.startswith('!d6'):
                await message.channel.send(str(message.author) + " il dado ha per te deciso:",
                                           file=discord.File(gen_d6()))
            elif message.content.startswith('!d8'):
                await message.channel.send(str(message.author) + " il dado ha per te deciso:",
                                           file=discord.File(gen_d8()))
            elif message.content.startswith('!d10'):
                await message.channel.send(str(message.author) + " il dado ha per te deciso:",
                                           file=discord.File(gen_d10()))
            elif message.content.startswith('!d12'):
                await message.channel.send(str(message.author) + " il dado ha per te deciso:",
                                           file=discord.File(gen_d12()))
            elif message.content.startswith('!d%'):
                await message.channel.send(str(message.author) + " il dado ha per te deciso:",
                                           file=discord.File(gen_d100()))
        else:
            if message.content.startswith('!d20'):
                ...
                if (comments):
                    if (num == 1):
                        ...
                        await message.channel.send(fails())
                    elif (num >= 11 and num < 15):
                        await message.channel.send(limit_numbers())
